...
yourself, and watch the network tab.

This is the whole application and all of it is free — the agent, the tools, the
document indexes, git and GitHub sync, MCP servers, the browser extension
bridge. There is no paid tier, no account, and nothing held back for a hosted
version. [localmd.app](https://localmd.app) is simply this repository, built and
deployed.
