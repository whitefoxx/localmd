...
<template>
  <div class="border-t border-border">
    ...
    <!-- ── Pricing, when the edition has a price. Sits after "what we don't
         do" and before the closing call to action: someone who has read this
         far is deciding, and "what will this cost me" is the last question
         before they do. ─────────────────────────────────────────────────── -->
    <component :is="PRICING_BLOCK" v-if="PRICING_BLOCK" />
