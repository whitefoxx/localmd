...
export default {
  en: {
    ...
    step3Title: 'Put an agent to work in it',
    step3Body:
      'Ask about a PDF and click the citation to land on the exact paragraph. It writes and links notes, and edits files with your approval.',
  ...
  zh: {
    ...
    step3Title: '让 agent 在里面干活',
    step3Body:
      '问一句 PDF 里的事，点引用就落到原文的那一段。它还能写笔记、建立链接，经你批准直接改文件。',
